...
<div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
	<div class="right_div">
		 <?php
	    	if(isset($_GET['name'])){
    			$cls=$_GET['name'];
    			$list="SELECT * FROM student WHERE cls='$cls' LIMIT 1";
	    		if($listinfo=mysql_query($list)){
	    			while ($found=mysql_fetch_assoc($listinfo)) {
			    		...
			    		echo '<div class="col-lg-4 col-sm-3 col-md-3 col-xs-12 " style="padding:0;overflow:hidden">
								<div class="albumname">
									<a href="stdlist.php?name='.$cls.'">
										<i class="fa fa-universal-access fa-spin" aria-hidden="true"></i>

										<h1>Class: '.$cls.' student list</h1>	
									</a>
								</div>
							</div>

							<div class="col-lg-4 col-sm-3 col-md-3 col-xs-12 " style="padding:0;overflow:hidden">
								<div class="albumname">
									<a href="addnewstudent.php?name='.$cls.'">
										<i class="fa fa-universal-access fa-spin" aria-hidden="true"></i>
										<h1>Add New Student in : '.$cls.'</h1>	
									</a>
								</div>
							</div>';
	    			}
